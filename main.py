...
lbl = tk.Label(window, text="Enter Your Rollnumber", width=20, height=2, fg="black", bg="Pink",
...
lbl3 = tk.Label(window, text=" NOTIFICATION", width=23, height=2,fg="black", bg="Pink",
                font=('Times New Roman', 25, ' bold '))
lbl3.place(x=1000 - x_cord, y=200 - y_cord)

message = tk.Label(window, text="", bg="white", fg="black", width=30, height=1, activebackground="white",
                   font=('Times New Roman', 15, ' bold '))
message.place(x=1075 - x_cord, y=300 - y_cord)

lbl3 = tk.Label(window, text="ATTENDANCE", width=20, fg="black", bg="Pink", height=1,
                font=('Times New Roman', 30, ' bold '))
lbl3.place(x=120, y=570 - y_cord)

message2 = tk.Label(window, text="", fg="black", bg="white", activeforeground="red", width=60, height=4,
                    font=('times', 15, ' bold '))
message2.place(x=700, y=570 - y_cord)

lbl4 = tk.Label(window, text="STEP 1", width=20, fg="black", bg="pink", height=2,
                font=('Times New Roman', 20, ' bold '))
lbl4.place(x=240 - x_cord, y=375 - y_cord)

lbl5 = tk.Label(window, text="STEP 2", width=20, fg="black", bg="pink", height=2,
                font=('Times New Roman', 20, ' bold '))
lbl5.place(x=645 - x_cord, y=375 - y_cord)

lbl6 = tk.Label(window, text="STEP 3", width=20, fg="black", bg="pink", height=2,
                font=('Times New Roman', 20, ' bold '))
...
def getImagesAndLabels(path):
    ...
    for imagePath in imagePaths:
        ...
        # Now we are converting the PIL image into numpy array(which the computer understands)
...
def TrackImages():
  #LBPH Recognizer is used to recognize our images against the dataset captured.
    ...
    attendance = pd.DataFrame(columns=col_names)    #creating "attendance.csv" file with the specified columns using "pandas"
    while True:
        ret, im = cam.read()
        ...
        for (x, y, w, h) in faces:
            ...
            Id, conf = recognizer.predict(gray[y:y + h, x:x + w])       #conf is the confidence. conf is inversely proprotional to recognition
            if (conf < 50):
                ts = time.time()
...
takeImg = tk.Button(window, text="IMAGE CAPTURE", command=TakeImages, fg="white", bg="blue", width=25, height=2,
                    activebackground="pink", font=('Times New Roman', 15, ' bold '))
takeImg.place(x=245 - x_cord, y=425 - y_cord)
trainImg = tk.Button(window, text="MODEL TRAINING", command=TrainImages, fg="white", bg="blue", width=25,
                     height=2, activebackground="pink", font=('Times New Roman', 15, ' bold '))
trainImg.place(x=645 - x_cord, y=425 - y_cord)
trackImg = tk.Button(window, text="TAKE ATTENDANCE", command=TrackImages, fg="white", bg="red", width=30,
